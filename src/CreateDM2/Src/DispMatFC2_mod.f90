...
module DispMatFC2
    ...
    public      :: IterOver_N2, IterOver_N2_mp2, find_force

contains

    subroutine  IterOver_N2(mu, alpha, FC2, sys, disp, force, Mat, force_mua)
    ...
    subroutine  IterOver_N2_mp2(mu, alpha, num_row, nstep, my_FC_indx, &
                              & sup_dim, FC2, disp, Mat)
    ...
    subroutine FindLC(Mat, disp, num_row, nstep, sup_dim, FC2, &
        ...
        dv_chk: if ( (dabs(dv+1.0_dp) < EPS) .or. (dabs(dv+7.0_dp) < EPS) ) then
            ...
            call find_ind9(Mat, FC2, num_row, mu, N2, alpha, beta, dsp_col)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv3_chk: if ( dabs(dep_var3+9.0_dp) < EPS ) then
                    ...
                    vec = cf * dsp_col
#endif
                    call find_ind9(Mat, FC2, num_row, fc_lc(1), fc_lc(2), a_lc, b_lc, vec)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv2_chk: if ( dabs(dep_var2+9.0_dp) < EPS ) then
                    ...
                    vec = cf * dsp_col
#endif
                    call find_ind9(Mat, FC2, num_row, mu, N2, a_lc, b_lc, vec)
