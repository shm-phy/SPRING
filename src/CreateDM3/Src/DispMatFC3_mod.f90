...
module DispMatFC3
    ...
    public      :: IterOver_N2_N3, IterOver_N2_N3_mp2, find_force

contains

    subroutine  IterOver_N2_N3(mu, alpha, FC3, sys, disp, force, Mat, force_mua)
    ...
    subroutine  IterOver_N2_N3_mp2(mu, alpha, num_row, nstep, my_FC_indx, &
                                    & sup_dim, FC3, disp, Mat)
        ...
        FC_part_loop: do ii = 1, my_FC_num
            ...
            dv8_chk: if ( dabs(dv - 8.0_dp) > EPS ) then
                call FindLC(Mat, disp, num_row, nstep, sup_dim, FC3, &
                          & mu, FCi(1), FCi(2), alpha, FCi(3), FCi(4), dv)
    ...
    subroutine FindLC(Mat, disp, num_row, nstep, sup_dim, FC3, &
        ...
        dv_chk: if ( (dabs(dv+1.0_dp) < EPS) .or. (dabs(dv+7.0_dp) < EPS) ) then
            ...
            call find_ind9(Mat, FC3, num_row, mu, N2, N3, alpha, beta, gama, dsp_col)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv3_chk: if ( dabs(dep_var3+9.0_dp) < EPS ) then
                    ...
                    vec = cf * dsp_col
#endif
                    call find_ind9(Mat, FC3, num_row, fc_lc(1), fc_lc(2), fc_lc(3), a_lc, b_lc, c_lc, vec)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv2_chk: if ( dabs(dep_var2+9.0_dp) < EPS ) then
                    ...
                    vec = cf * dsp_col
#endif
                    call find_ind9(Mat, FC3, num_row, mu, N2, N3, a_lc, b_lc, c_lc, vec)
