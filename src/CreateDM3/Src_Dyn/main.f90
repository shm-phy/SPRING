...
program main
    ...
    ! =================== Initialize (All images dose file reading in parallel) ==================== !
    ...
    allocate( Mat(num_row, FC3%ind_fc)[*], STAT=istat, ERRMSG=msg )
    ...
    DynSchdChk: if ( DynSchd ) then
        ...
        OnlyImg1: if ( this_image() == 1 ) then
            ...
            !      The division looks follows (The length of each chunk Chnklen = (NFC_tot / Nchunk) :      !
            !                                                                                               !
            !                                     --------------------------                                !
            !                                     | 1          |  Chnklen  |                                !
            !                                     --------------------------                                !
            ...
            NotImage1: if ( this_image() >= StrtImg ) then
                ...
                DynSchdl: do
                    ...
                    StartWork: if ( PickFlag == 0 ) then
                        ...
                        call IterOver_N2_N3_mp2(mu, alpha, num_row, nstep, NumDef_sup, PointDef, &
