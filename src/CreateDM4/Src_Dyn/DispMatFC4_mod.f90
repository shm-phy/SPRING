...
module DispMatFC4
    ...
    public      :: IterOver_N2_N3_N4_mp2, find_force

contains

    subroutine  IterOver_N2_N3_N4_mp2( mu, alpha, num_row, nstep, NumDef_sup, PointDef, &
        ...
        FC_part_loop: do ii = 1, my_FC_num
            ...
            dv8_chk: if ( dabs(dv - 8.0_dp) > EPS ) then
                ...
                call FindLC( Mat, disp, num_row, nstep, sup_dim, FC4, &
                           & mu, FCi(1), FCi(2), FCi(3), alpha, FCi(4), FCi(5), FCi(6), &
    ...
    subroutine FindLC(Mat, disp, num_row, nstep, sup_dim, FC4, &
                    & mu, N2, N3, N4, alpha, beta, gama, delta, &
        ...
        call find_disp_coeff( FC4, sup_dim, nstep, num_row, mu, N2, beta, &
                            & N3, gama, N4, delta, NumDef_sup, PointDef, &
                            & cell_atm_def, disp, flags, dsp_col )
        ...
        dv_chk: if ( (dabs(dv+1.0_dp) < EPS) .or. (dabs(dv+7.0_dp) < EPS) ) then
            ...
            call find_ind9(Mat, FC4, num_row, mu, N2, N3, N4, alpha, beta, gama, delta, 1.0_dp, dsp_col)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv3_chk: if ( dabs(dep_var3+9.0_dp) < EPS ) then
                    ...
                    call find_ind9(Mat, FC4, num_row, fc_lc(1), fc_lc(2), fc_lc(3), fc_lc(4), a_lc, b_lc, c_lc, d_lc, cf, dsp_col)
                    ...
                    write(*, 62) dep_var3
                    62 FORMAT('Illegal value of dep_var3 encountered', E14.6)
                    ERROR STOP
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv2_chk: if ( dabs(dep_var2+9.0_dp) < EPS ) then
                    ...
                    call find_ind9(Mat, FC4, num_row, mu, N2, N3, N4, a_lc, b_lc, c_lc, d_lc, cf, dsp_col)
                    ...
                    write(*, 62) dep_var2
                    62 FORMAT('Illegal value of dep_var2 encountered', E14.6)
                    ERROR STOP
