...
module FC4_data_mod
    ...
    type, public    :: Chunk7d
        ...
        integer, dimension(:,:,:,:,:,:,:), allocatable              :: Arr7d
    ...
    type, public    :: FC4_dat
        ...
        type(Chunk7d), dimension(:), allocatable                    :: PosIndx      !*!

        integer, dimension(:, :), allocatable                       :: PosIndx_flat_old

        type(Chunk7d), dimension(:), allocatable                    :: PosIndx_old  !*!
...
subroutine set_FC4dat(this, filename)
    ...
    integer                                                 :: Nbasis, Natm, mu, Natm_mu, &
                                                             & Ndep, ii                                 ! Sparse

    character(len=24)                                       :: mu_char, Indx_char                                ! Sparse 
    ...
    write(*, 132) filename
    132 FORMAT('Reading Fourth order FC data from file: ', A64)
    ...
    call h5fopen_f(filename, H5F_ACC_RDONLY_F, file_id, hdferr) !output -> file_id
        call h5gopen_f(file_id, grp_name1, grp_id1, hdferr) !Open and existing group, output -> grp_id1
            ...
            call h5gopen_f(grp_id1, grp_name2, grp_id_in, hdferr) !Open and existing group, output -> grp_id_in
                ...
                mu_loop1: do mu = 1, Nbasis
                    ...
                    this%PosIndx(mu)%Arr7d(:,:,:,:,:,:,:) = PosIndx_part(:,:,:,:,:,:,:)
        ...
        call h5gopen_f(file_id, grp_name4, grp_id1, hdferr) !Open and existing group, output -> grp_id
            ...
            allocate( this%PosIndx_old(Nbasis) )
            ...
            call h5gopen_f(grp_id1, grp_name5, grp_id_in, hdferr) !Open and existing group, output -> grp_id_in
                ...
                mu_loop3: do mu = 1, Nbasis
                    ...
                    allocate( this%PosIndx_old(mu)%Arr7d(3, 3, 3, 3, Natm_mu, Natm_mu, Natm_mu) )
                    ...
                    this%PosIndx_old(mu)%Arr7d(:,:,:,:,:,:,:) = PosIndx_part(:,:,:,:,:,:,:)
