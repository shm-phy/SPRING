...
contains
    ...
    subroutine TransformAtoms(sys, atm1cb, atm2cb, Rot, Trans)

        implicit none

        type(cell), intent(in)                          :: sys

        integer, dimension(4), intent(inout)            :: atm1cb, atm2cb
        ...
        integer, dimension(4, ordfc2)                   :: atmcb
        real(dp), dimension(3, ordfc2)                  :: atom, atomc, atm_frac
        integer, dimension(3, ordfc2)                   :: atm_int

        integer, dimension(ordfc2)                      :: basis_indx
