...
subroutine ApplyASR(this, Cut_Off, Nbasis)
    ...
    integer                                 :: mu, Natm_mu, N2, N3, alpha, beta, gama, &
                                             & asr_count
    ...
    NumASR = Nbasis * ( (NatmMax ** (ordfc3-2)) * (3**ordfc3) )
    ...
    !$omp parallel do default(shared) &
                ...
                !$omp private(mu, N2, alpha, beta, gama, Natm_mu, N3, asr_count) &
