...
contains
    ...
    subroutine TransformAtoms(sys, atm1cb, atm2cb, atm3cb, &
                            & Rot, Trans)
        ...
        integer, dimension(4, ordfc3)                   :: atmcb
        real(dp), dimension(3, ordfc3)                  :: atom, atomc, atm_frac
        integer, dimension(3, ordfc3)                   :: atm_int

        integer, dimension(ordfc3)                      :: basis_indx
