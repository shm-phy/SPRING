...
module constants
    ...
    real(dp), parameter             :: Sctr3THz2 = 1.054571817_dp * ( (1.60217733_dp)**2 ) * &
                                                 & ( (6.02214076_dp) ** 3 ) * 1000000.0_dp * PI * 0.25_dp
    
    real(dp), parameter             :: FunitE_11m_K = ( 1.054571817_dp / 1.380649_dp )

    real(dp), parameter             :: kW_mK = ( 1.054571817_dp * 0.001_dp )

    real(dp), parameter             :: taups = ( 1.380649_dp / 1.054571817_dp )

    private
    public                          :: PI, cmp_prec, zero_prec, OneSixth, OneThird, EPS, MAX_ITER, iu, &
                                     & eV_A2, wTHz, THzConv, vg_ms, A2Conv, BEConv, Sctr3THz2, &
                                     & FunitE_11m_K, kW_mK, taups
