...
contains
    ...
    subroutine set_Phon(this, sys, FC2, EwaldConst, qpoints, T, freq_cut, Ndof, LongEW)
    ...
    subroutine set_Phon_mp(this, sys, FC2, EwaldConst, qpoints, T, freq_cut, Ndof, LongEW)
