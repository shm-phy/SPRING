...
module ReconstFC2
    ...
    public      :: IterOver_N2, IterOver_N2_mp2

contains

    subroutine  IterOver_N2(FC2, Nbasis, FC_full)
        ...
        integer                                 :: mu, N2, alpha, beta

        !.......................  Local variables     .........................!

        Nmax = maxval( FC2%atmNum )
        total = Nbasis * Nmax * (3**2)
        cnt = 1
            ...
            N2_loop: do N2 = 1, Nmax
                alpha_loop: do alpha = 1, 3
                    beta_loop: do beta = 1, 3
                        ...
                        NatmBound: if ( N2 <= Natm_mu ) then

                            call FindLC(FC2, mu, N2, alpha, beta, fc_val)

                            FC_full( beta, alpha, N2, mu ) = fc_val
    ...
    subroutine  IterOver_N2_mp2(my_FC_indx, FC2, FC_part)
        ...
        FC_part_loop: do ii = 1, my_FC_num
            ...
            call FindLC(FC2, FCi(1), FCi(2), FCi(3), FCi(4), fc_val)

            FC_part( FCi(4), FCi(3), FCi(2), FCi(1) ) = fc_val
    ...
    subroutine FindLC(FC2, mu, N2, alpha, beta, fc)
        ...
        dv_chk: if ( (dabs(dv+1.0_dp) < EPS) .or. (dabs(dv+7.0_dp) < EPS) ) then
            ...
            call find_ind17(FC2, mu, N2, alpha, beta, fc)

        else if ( dabs(dv+5.0_dp) < EPS ) then dv_chk

            call find_ind5(FC2, mu, N2, alpha, beta, fc)

        else if ( dabs(dv+9.0_dp) < EPS ) then dv_chk

            call find_ind9(FC2, mu, N2, alpha, beta, 1.0_dp, fc)
    ...
    subroutine find_ind17(FC2, mu, N2, &
                        & alpha, beta, fc)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv3_chk: if ( dabs(dep_var3+9.0_dp) < EPS ) then
                    ...
                    call find_ind9(FC2, fc_lc(1), fc_lc(2), &
                                 & a_lc, b_lc, cf, my_fc9)
                    ...
                    col_no_chk: if ( (col_no == FILLVAL) .or. (col_no > FC2%ind_fc) ) then
                        ...
                        my_fc17 = my_fc17 + ( cf * FC2%FC2_ind(col_no) )
    ...
    subroutine find_ind5(FC2, mu, N2, alpha, beta, fc)
        ...
        coef_lc_loop: do jj = 1, MAX_CF
            ...
            cf0_chk: if ( dabs(cf) > EPS ) then
                ...
                dv2_chk: if ( dabs(dep_var2+9.0_dp) < EPS ) then
                    ...
                    call find_ind9(FC2, mu, N2, a_lc, b_lc, cf, my_fc9)
                    ...
                    col_no_chk: if ( (col_no == FILLVAL) .or. (col_no > FC2%ind_fc) ) then
                        ...
                        my_fc5 = my_fc5 + ( cf * FC2%FC2_ind(col_no) )
    ...
    subroutine find_ind9(FC2, mu, N2, &
                       & a, b, cf_in, fc)
        ...
        mat_el_loop: do jj = 1, num_el
            ...
            col_no_chk: if ( (col_no == FILLVAL) .or. (col_no > FC2%ind_fc) ) then
                ...
                my_fc9 = my_fc9 + ( cf_in * mat_el * FC2%FC2_ind(col_no) )
