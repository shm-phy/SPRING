...
module FC3_data_mod
    ...
    type, public    :: FC3_dat
        ...
        real(dp), dimension(:), allocatable                         :: FC3_ind
...
subroutine set_FC3dat(this, filename, fc3indfc_file)
    ...
    img1_chk: if ( this_image() == 1 ) then
        write(*, 132) filename, fc3indfc_file
        132 FORMAT('Reading Third order FC data from file: ', A24, ', and independent FC file: ', A24)
    end if img1_chk

    !.............................................. FC3_ind ................................................!
    call h5open_f(hdferr)

    call h5fopen_f(fc3indfc_file, H5F_ACC_RDONLY_F, file_id, hdferr) !output -> file_id
        call h5gopen_f(file_id, grp_name_indfc, grp_id1, hdferr) !Open and existing group, output -> grp_id1
            ...
            call h5sget_simple_extent_dims_f(space_id, dims1, maxdims1, hdferr) !output -> dims1
                                                                                ! maxdims1
            allocate( this%FC3_ind(1:dims1(1)) )
            call h5dread_f(dset_id, type_id, this%FC3_ind, dims1, hdferr) !Read in array 'FC3_ind'
