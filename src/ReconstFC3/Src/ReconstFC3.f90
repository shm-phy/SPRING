...
module ReconstFC3
    ...
    public      :: IterOver_N2_N3, IterOver_N2_N3_mp2
...
contains
    ...
    subroutine  IterOver_N2_N3(FC3, Nbasis, FC_full)
        ...
        real(dp)                                :: fc_val
        integer                                 :: Nmax, Natm_mu, total, cnt
    ...
    subroutine  IterOver_N2_N3_mp2(my_FC_indx, FC3, FC_part)
        ...
        FC_part_loop: do ii = 1, my_FC_num
            ...
            call FindLC(FC3, FCi(1), FCi(2), FCi(3), FCi(4), FCi(5), FCi(6), fc_val)

            FC_part( FCi(6), FCi(5), FCi(4), FCi(3), FCi(2), FCi(1) ) = fc_val
