...
subroutine print_err_msg(err, nn, cmd_line, expected_cmd_line)
    ...
    subroutine ShowWelcomeBanner()
        ...
        40 FORMAT(10X, "Executable: reconst3_omp.x (Reconstruction of whole set of 3rd-order IFCs from symmetrically reduced set)")
