...
contains
    ...
    subroutine  IterOver_N2_N3_N4(FC4, Nbasis, FC_full)
        ...
        !$omp parallel do default(shared) &
                    ...
                    !$omp private(fc_val, mu, N2, N3, N4, alpha, beta, gama, delta, Natm_mu) &
                    !$omp shared(FC4, FC_full, Nbasis, Nmax, total, cnt, chunk) &
                    !$omp collapse(8)
                            ...
                            beta_loop: do beta = 1, 3
                                gama_loop: do gama = 1, 3
                                    delta_loop: do delta = 1, 3
                                        ...
                                        NatmBound: if ( (N2 <= Natm_mu) .and. (N3 <= Natm_mu) .and. &
                                                      & (N4 <= Natm_mu) ) then
