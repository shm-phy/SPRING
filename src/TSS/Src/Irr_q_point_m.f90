...
contains
    ...
    subroutine make_tetrahedron(this, sys, mesh, shift)
        ...
        iz_loop: do iz = 0, (mesh(3) - 1)
            iy_loop: do iy = 0, (mesh(2) - 1)
                ix_loop: do ix = 0, (mesh(1) - 1)
                    ...
                    ! q(v) = grid_pnt_tetra( :, grid_indx_tetra( tetrahedrons(v, tetra_count) ) )   !
        ...
        ! q-points is obtained from indx_map (or grid_indx_tetra). Which 'qfirst' in the symmetrically related set of qs is     !
        ...
        ! Both q and -q1 in the 'map' is assigned indx_qfirst here.                                                             !
        map = 0
        ...
        ! 'tmp_arr' is a 1d array of size ( mesh(1)*mesh(2)*mesh(3) ). For a single q among the symmetrically related set of qs !
        ...
        ! this%q_pnt_int(1:3, :) = grid_pnt_tetra(:, :). The fourth alue this%q_pnt_int(4, :) is a integer which corresponds    !
        ...
        allocate( this%q_pnt_int(4, num_grid_pnt) )
        ...
        !*!     write(*, 22) this%q_pnt_int(1:3, ii) , this%q_pnt_int(4, ii), this%irr_q_int(1:3, this%q_pnt_int(4, ii)), &
        !*!                & this%irr_q_int(4, this%q_pnt_int(4, ii))
        !*!     22 FORMAT('(', 2(I3, ', '), I3, ') ', ' ( ', I0, ' ) --> ', '(', 2(I3, ', '), I3, ') ', '[', I0, ']',/)
