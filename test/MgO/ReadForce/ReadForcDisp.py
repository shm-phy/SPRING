...
class Read_lammps :
    ...
    def __init__(self, nml_fname, lammps_init_force_file, lammps_trj_file ) :
...
if __name__ == "__main__" :
    ...
    # Run: python3 ReadForcDisp.py -inp input.nml -T 80 -ts 5000 -DFfile out.log -MDEfile NaCl.MDE
    ...
    if ( MD == 'siesta' ) :
        ...
        data = ReadSIESTA(nml_fname, siestafile, mde_file, total_ts, \
                          Tmean, ts_cut, dT=Taccu, d_time=t_skip)
        data.ReadCord()
        data.ReadForce()
        data.Writeh5(T)
