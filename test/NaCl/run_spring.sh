...
# Executalble
PWD_EXEC1=/home/soham/Dropbox/Linux@Dropbox/PROJECTS/PHONON/SPRING/bin
PWD_EXEC2=/home/soham/Dropbox/Linux@Dropbox/PROJECTS/PHONON/SPRING/bin

#Directory where the nml file and displacement-force data-set is stored
Dir_Nml_file=${DIR_CURRENT_CONFIG}/ReadForce
...
mv -v ${Dir_LSq}/Least_Sqr/FD_2nd_${prefix}${TEMP}K.h5 ${Dir_SeconWith4th}/SecondOrderWith4th
mv -v ${Dir_LSq}/Least_Sqr/FD_3rd_${prefix}${TEMP}K.h5 ${Dir_SeconWith4th}/SecondOrderWith4th
mv -v ${Dir_LSq}/Least_Sqr/FC2_dd_${prefix}${TEMP}K.h5 ${Dir_SeconWith4th}/SecondOrderWith4th
